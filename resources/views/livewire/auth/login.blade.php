<div class="mx-4 w-full max-w-6xl p-5">


    <form class="mx-auto flex flex-col justify-evenly" wire:submit.prevent="login">
        @csrf
        <div>
        ...
        <div class="my-2 flex flex-col justify-around gap-4 md:flex-row">
            <div class="flex-1 flex-row">
                <a class="btn min-w-full bg-white" href="{{ route('auth.google') }}" role="button">
